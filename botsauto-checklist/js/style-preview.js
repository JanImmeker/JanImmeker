jQuery(function($){
  ...
  function updatePreview(){
    ...
    if(adv.phase){
      css += w+' .botsauto-phase>details>.phase-toggle{color:'+adv.phase['text-color']+';background:'+adv.phase['background-color']+';font-size:'+adv.phase['font-size']+';font-weight:'+adv.phase['font-weight']+';list-style:none;position:relative;padding-left:1.2em;padding-top:10px;padding-bottom:10px;}';
      ...
      css += w+' .botsauto-phase>details>.phase-toggle::before{content:"▶";position:absolute;left:0;}';
      css += w+' .botsauto-phase[open]>details>.phase-toggle::before{content:"▼";}';
    }
    if(adv.question){
      css += w+' .botsauto-question-text{color:'+adv.question['text-color']+';font-size:'+adv.question['font-size']+';font-style:'+adv.question['font-style']+';margin:0 0 .2em;flex-basis:100%;display:flex!important;align-items:center;justify-content:space-between;}';
    ...
    if(adv.info_button){
      css += w+' .botsauto-info-btn{background:'+adv.info_button['background-color']+';color:'+adv.info_button['text-color']+';padding:'+adv.info_button.padding+';border-radius:'+adv.info_button['border-radius']+';border-color:'+adv.info_button['border-color']+';border-style:solid;line-height:1;vertical-align:middle;}';
    }
    if(adv.info_popup){
      css += w+' .botsauto-info-content{background:'+adv.info_popup['background-color']+';color:'+adv.info_popup['text-color']+';padding:'+adv.info_popup.padding+';border-radius:'+adv.info_popup['border-radius']+';margin-top:.5em;}';
    }
   if(adv.field){
